...
# Downloaded from
# https://github.com/ansible/ansible/blob/3765dc37/lib/ansible/modules/system/parted.py
# With modifications to add fs_type and to fix disk labeling
...
def main():
    ...
    module = AnsibleModule(
        argument_spec={
            ...
            'fs_type': {
                'choices': ['ext4', 'fat16', 'fat32', 'ext2', 'HFS',
                            'linux-swap', 'NTFS', 'reiserfs', 'ufs'],
                'type': 'str'
            },
    ...
    fs_type     = module.params['fs_type'] or ''
