#!/usr/bin/env python
# From https://bitbucket.org/psagers/ansible-ldap
...
class LdapAttr(object):
    def __init__(self, module):
        ...
        self.raw_values = self.module.params['values']
    ...
    def _normalized_values(self):
        ...
        if not (isinstance(values, list) and
                all(isinstance(value, basestring) for value in values)):
            self.module.fail_json(
                msg="values must be a string or list of strings.")
